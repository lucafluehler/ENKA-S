...
double Rotor3D::norm2() const { return s * s + b_xy * b_xy + b_xz * b_xz + b_yz * b_yz; }

double Rotor3D::norm() const { return std::sqrt(norm2()); }
...
Rotor3D Rotor3D::get_reverse() const { return Rotor3D(s, -b_xy, -b_xz, -b_yz); }
