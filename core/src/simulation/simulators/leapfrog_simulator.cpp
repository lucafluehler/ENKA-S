...
void LeapfrogSimulator::initialize(std::shared_ptr<data::System> initial_system,
...
void LeapfrogSimulator::step(std::shared_ptr<data::System> system_buffer,
...
void LeapfrogSimulator::calculateNextSystemState() {
