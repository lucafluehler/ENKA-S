    ...
    , ui(new Ui::RenderSettingsWidget)
{
    ...
    addAnimationStyle("Im Uhrzeigersinn",  AnimationStyle::CWISE);
    addAnimationStyle("Im Gegenuhrzeigersinn",  AnimationStyle::CNTRCWISE);
    addAnimationStyle("Tutti",  AnimationStyle::TUTTI);

    // Map Coloring Methods
    addColoringMethod("Schwarzer Nebel", ColoringMethod::BLACK_FOG);
    addColoringMethod("Weisser Nebel", ColoringMethod::WHITE_FOG);

    // Load defaults
    // loadRenderSettings(RenderSettings());

    // Signal Management
    connect( ui->cbxAnimation, &QComboBox::activated
           , this, &RenderSettingsWidget::disableAnimationSpeed );
    connect( ui->cbxColoringMethod, &QComboBox::activated
           , ui->stwColoringSettings, &QStackedWidget::setCurrentIndex );

    // Settings changed
    connect( ui->chbShowCOM, &QCheckBox::stateChanged
           , this, &RenderSettingsWidget::settingsChanged );
    connect( ui->chbShowCenter, &QCheckBox::stateChanged
           , this, &RenderSettingsWidget::settingsChanged );
    connect( ui->cbxAnimation, &QComboBox::currentIndexChanged
           , this, &RenderSettingsWidget::settingsChanged );
    connect( ui->dsbAnimationSpeed, &QDoubleSpinBox::valueChanged
           , this, &RenderSettingsWidget::settingsChanged );
    connect( ui->cbxColoringMethod, &QComboBox::currentIndexChanged
           , this, &RenderSettingsWidget::settingsChanged );
    connect( ui->dsbBlackFogParam, &QDoubleSpinBox::valueChanged
           , this, &RenderSettingsWidget::settingsChanged );
    connect( ui->dsbWhiteFogParam, &QDoubleSpinBox::valueChanged
           , this, &RenderSettingsWidget::settingsChanged );
    connect( ui->sbxFOV, &QSpinBox::valueChanged
           , this, &RenderSettingsWidget::settingsChanged );
    connect( ui->sbxFPS, &QSpinBox::valueChanged
           , this, &RenderSettingsWidget::settingsChanged );
    connect( ui->dsbParticleSize, &QDoubleSpinBox::valueChanged
            , this, &RenderSettingsWidget::settingsChanged );
}
